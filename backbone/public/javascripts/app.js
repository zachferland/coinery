...
module.exports = Product = (function(_super) {
  ...
  Product.prototype.getCoverURL = function() {
  ...
  Product.prototype.getPublished = function() {
  ...
  Product.prototype.getReadableStatus = function(e) {
    var s;
    s = '';
...
module.exports = User = (function(_super) {
  ...
  User.prototype.getCoinbaseAuth = function() {
    return this.get('coinbase_auth');
  };
...
var AccountView, AnalyticsView, CustomersView, EditProductView, LoginView, NewProductView, Product, ProductsCollection, ProductsView, Router, SidebarView, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
module.exports = Router = (function(_super) {
  ...
  Router.prototype.analyticsHandler = function() {
    var analytics;
    if (this.session()) {
  ...
  Router.prototype.loadView = function(view) {
    ...
    return delay(210, function() {
      if (_this.view.killSubviews != null) {
        _this.view.killSubviews();
      }
...
;require.register("templates/analytics", function(exports, require, module) {
var __templateData = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div class=\"coming-soon\" style=\"margin-top: 118px;\">\n  <span class=\"cs-flag\">Coming Soon!</span>\n  <p>See your customers and purchases in realtime</p>\n</div>\n\n";
  });
if (typeof define === 'function' && define.amd) {
  define([], function() {
    return __templateData;
...
function program7(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "\n  </p>\n  <div class=\"coming-soon\" style=\"position: absolute; right: -220px; top: 40px;\">\n    <span class=\"cs-flag\">Coming Soon!</span>\n    <p style=\"font-size: .8rem;\">Overlay your product on any website with a simple code snippet</p>\n  </div>\n</div>\n";
  return buffer;
  }

  stack1 = helpers.unless.call(depth0, (depth0 && depth0.has_coinbase_auth), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  ...
  buffer += escapeExpression(stack1)
    + "</strong> </h2>\n  ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.published), {hash:{},inverse:self.program(5, program5, data),fn:self.program(3, program3, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n  <a class=\"button small right gray\" data-href=\"save\">Save Draft</a>\n</header>\n\n";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.published), {hash:{},inverse:self.noop,fn:self.program(7, program7, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
...
function program13(depth0,data) {
  ...
  return "Add a description of your product...";
  }

  buffer += "<div class=\"overlay\">\n  <div class=\"flag ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.published), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\">\n    ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.published), {hash:{},inverse:self.program(5, program5, data),fn:self.program(3, program3, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n    <img src=\"images/flag.svg\" width=\"81\" height=\"81\">\n  </div>\n  <div class=\"cover\">\n      ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.cover), {hash:{},inverse:self.program(9, program9, data),fn:self.program(7, program7, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n  </div>\n  <div class=\"product-main\">\n    <div class=\"unsaved\">\n      <span class=\"warning\">Warning</span>\n      <p>Don't forget to save your changes!</p>\n    </div>\n    <div class=\"field-container\">\n      <div class=\"title-container\">\n        <input class=\"title\" data-id=\"title\" value=\"";
  if (helper = helpers.title) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.title); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "\">\n      </div>\n      <div class=\"price-container\">\n        <div class=\"field-wrapper\" data-currency=\"BTC\">\n          <input class=\"btc\" type=\"text\">\n        </div>\n        <div class=\"field-wrapper\" data-currency=\"USD\">\n          <input data-id=\"price\" class=\"usd\" type=\"text\">\n        </div>\n      </div>\n    </div>\n    <div data-id=\"description\" class=\"description\" contenteditable>";
...
function program2(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "</h4>\n            </div>\n            ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.cover), {hash:{},inverse:self.program(5, program5, data),fn:self.program(3, program3, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
...
;require.register("views/analytics", function(exports, require, module) {
var AnalyticsView, Template, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

Template = require('templates/analytics');

module.exports = AnalyticsView = (function(_super) {
  __extends(AnalyticsView, _super);

  function AnalyticsView() {
    _ref = AnalyticsView.__super__.constructor.apply(this, arguments);
    return _ref;
  }

  AnalyticsView.prototype.el = '.content';
...
module.exports = EditProductView = (function(_super) {
  ...
  EditProductView.prototype.render = function() {
    ...
    ctx = {
      ...
      'has_coinbase_auth': this.user.getCoinbaseAuth(),
      'published': this.model.getPublished(),
      'id': this.model.id
    };
  ...
  EditProductView.prototype.renderSubviews = function() {
    this.renderOverlay();
    return this.renderFiles();
  };

  EditProductView.prototype.previewHandler = function(e) {
    var _this = this;
    $('.olrk-noquirks').hide();
    $('.preview-iframe').show();
    $('.preview-iframe').attr("src", "/products?id=" + this.model.id);
    return window.addEventListener('message', function(event) {
      if (event.data === 'close_preview') {
        return _this.resetPreview();
      }
    }, false);
  };

  EditProductView.prototype.resetPreview = function(e) {
    return $('.preview-iframe').fadeOut();
  };

  EditProductView.prototype.killSubviews = function() {
    var view, _i, _len, _ref1, _results;
    _ref1 = [this.overlay, this.files];
    _results = [];
    for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
      view = _ref1[_i];
      if (view != null) {
        view.undelegateEvents();
        _results.push(view.$el.html(''));
      } else {
  ...
  EditProductView.prototype.saveHandler = function(e) {
    var description, price, title,
      _this = this;
    ...
    return this.model.save({}, {
      ...
      async: false,
      success: function(response) {
        return $('.unsaved').removeClass('visible');
      }
    });
  };
  ...
  EditProductView.prototype.publishHandler = function(e) {
    ...
    e.preventDefault();
    this.saveHandler();
    if (!this.user.getCoinbaseAuth()) {
      this.$('.coinery-cta').show(function() {
        $(this).addClass('visible');
      });
    }
    this.model.setStatus(2);
    return this.model.save({}, {
      url: "/api/products/" + (this.model.get('id')) + "/publish",
      success: function(response) {
        return _this.render();
      }
    });
  ...
  EditProductView.prototype.coinbaseAuthHandler = function(e) {
    var _this = this;
    e.preventDefault();
    window.open(window.cb_auth_url);
    return window.addEventListener("focus", function(event) {
      return _this.user.fetch({
        success: function(response) {
          if (_this.user.getCoinbaseAuth) {
            return _this.render();
          }
        }
      });
...
module.exports = FilesView = (function(_super) {
  ...
  FilesView.prototype.initialize = function(options) {
    this.user = options.user;
    this.model.getAssetsFromServer();
  ...
  FilesView.prototype.fileDeleteHandler = function(e) {
    ...
    if (this.dropzone.files.length < 2) {
  ...
  NewProductView.prototype.currencyHandler = function(e) {
    ...
    if (focus === 'BTC') {
      ...
      if (!isNaN(usd)) {
        ...
        delay(150, function() {
          return inputs.usd.val("$" + (usd.toFixed(2).toString()));
        });
        delay(300, function() {
    ...
    if (focus === 'USD') {
      ...
      if (!isNaN(btc)) {
        ...
        delay(150, function() {
          return inputs.btc.val(parseFloat(btc.toFixed(5)));
        });
        delay(300, function() {
...
module.exports = OverlayView = (function(_super) {
  ...
  OverlayView.prototype.showWarning = function(e) {
    return $('.unsaved').addClass('visible');
  };
  ...
  OverlayView.prototype.fillPrice = function() {
    var btc, btc_float, price, rate, usd;
    rate = window.conversion_rate;
    if (!rate) {
      rate = 1 / 540;
    }
  ...
  OverlayView.prototype.dropzoneInit = function() {
    ...
    dropzone = new Dropzone('a[data-href="cover-dropzone"]', {
      ...
      url: "/api/products/" + (this.model.get('id')),
      paramName: 'image',
      method: 'put'
    });
    ...
    return dropzone.on('success', function(file) {
      return delay(500, function() {
        return _this.model.fetch({
          url: "/api/products/" + (_this.model.get('id')),
          success: function(response) {
            return _this.render();
          }
        });
